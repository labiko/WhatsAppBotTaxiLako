...
// Initialisation du client Supabase avec les clés en dur pour Twilio
const supabaseUrl = 'https://nmwnibzgvwltipmtwhzo.supabase.co'
const supabaseServiceKey = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im5td25pYnpndndsdGlwbXR3aHpvIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc1MzE4NjkwMywiZXhwIjoyMDY4NzYyOTAzfQ._TeinxeQLZKSowSCUswDR54WejQp1c9y_tkn6MLYh_M'
  ...
  try {
    ...
    if (body.includes('taxi') || body.includes('je veux un taxi')) {
      ...
      if (session && session.vehicle_type) {
        ...
        console.log(`Tentative d'insertion pour ${clientPhone}: ${session.vehicle_type} à ${point}`)
