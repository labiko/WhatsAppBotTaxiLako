...
Pour recommencer: écrivez 'taxi'`;
      ...
      const reservationData = {
        ...
        // Données temporelles pour réservations planifiées
        date_plannee: session.temporalPlanning ? session.plannedDate : null,
        heure_plannee: session.temporalPlanning ? session.plannedHour : null
      };
